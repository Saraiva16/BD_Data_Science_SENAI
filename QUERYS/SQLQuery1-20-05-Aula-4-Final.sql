...
UPDATE Funcionarios SET NOME = 'André Silva' WHERE COD_FUNC = 5;
UPDATE Funcionarios SET NOME = 'José Moraes' WHERE COD_FUNC = 6;
UPDATE Funcionarios SET NOME = 'Marcos Estevam' WHERE COD_FUNC = 8;